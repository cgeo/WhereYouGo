...
class FilePickerIconAdapter extends BaseAdapter {
     ...
     *
     * @param context the context of this adapter, through which new Views are created.
     */
    ...
    public View getView(int index, View convertView, ViewGroup parent) {
        ...
        if (index == 0 && this.hasParentFolder) {
            ...
            if (this.currentFile.isDirectory()) {
                this.textView.setCompoundDrawablesWithIntrinsicBounds(0, R.drawable.file_picker_folder, 0,
                        0);
            } else {

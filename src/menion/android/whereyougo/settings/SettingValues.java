...
import static menion.android.whereyougo.settings.Settings.DEFAULT_GPS_MIN_TIME_NOTIFICATION;
import static menion.android.whereyougo.settings.Settings.DEFAULT_GUIDING_COMPASS_SOUNDS;
import static menion.android.whereyougo.settings.Settings.DEFAULT_GUIDING_GPS_REQUIRED;
import static menion.android.whereyougo.settings.Settings.DEFAULT_GUIDING_WAYPOINT_SOUND;
import static menion.android.whereyougo.settings.Settings.DEFAULT_GUIDING_WAYPOINT_SOUND_DISTANCE;
import static menion.android.whereyougo.settings.Settings.DEFAULT_HARDWARE_COMPASS_AUTO_CHANGE;
import static menion.android.whereyougo.settings.Settings.DEFAULT_HARDWARE_COMPASS_AUTO_CHANGE_VALUE;
...
import static menion.android.whereyougo.settings.Settings.DEFAULT_UNITS_ALTITUDE;
import static menion.android.whereyougo.settings.Settings.DEFAULT_UNITS_ANGLE;
...
import static menion.android.whereyougo.settings.Settings.KEY_S_GPS_MIN_TIME_NOTIFICATION;
import static menion.android.whereyougo.settings.Settings.KEY_S_GUIDING_WAYPOINT_SOUND;
import static menion.android.whereyougo.settings.Settings.KEY_S_GUIDING_WAYPOINT_SOUND_DISTANCE;
import static menion.android.whereyougo.settings.Settings.KEY_S_HARDWARE_COMPASS_AUTO_CHANGE_VALUE;
import static menion.android.whereyougo.settings.Settings.KEY_S_HIGHLIGHT;
import static menion.android.whereyougo.settings.Settings.KEY_S_SENSORS_ORIENT_FILTER;
import static menion.android.whereyougo.settings.Settings.KEY_S_UNITS_ALTITUDE;
import static menion.android.whereyougo.settings.Settings.KEY_S_UNITS_ANGLE;
...
public class SettingValues {
	...
	public static void init(Context c) {
		...
		SENSOR_HARDWARE_COMPASS_AUTO_CHANGE_VALUE = Utils.parseInt(getPrefString(c,
		...
		GUIDING_WAYPOINT_SOUND_DISTANCE = Utils.parseInt(getPrefString(c,
				KEY_S_GUIDING_WAYPOINT_SOUND_DISTANCE, DEFAULT_GUIDING_WAYPOINT_SOUND_DISTANCE));
	}
}

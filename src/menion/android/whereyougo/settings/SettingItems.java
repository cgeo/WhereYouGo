...
import static menion.android.whereyougo.settings.Settings.DEFAULT_GUIDING_WAYPOINT_SOUND;
import static menion.android.whereyougo.settings.Settings.DEFAULT_LANGUAGE;
import static menion.android.whereyougo.settings.Settings.KEY_S_GUIDING_WAYPOINT_SOUND;
import static menion.android.whereyougo.settings.Settings.KEY_S_LANGUAGE;
import static menion.android.whereyougo.settings.Settings.VALUE_GUIDING_WAYPOINT_SOUND_BEEP_ON_DISTANCE;
import static menion.android.whereyougo.settings.Settings.VALUE_GUIDING_WAYPOINT_SOUND_CUSTOM_SOUND;
import static menion.android.whereyougo.settings.Settings.VALUE_GUIDING_WAYPOINT_SOUND_CUSTOM_SOUND_URI;
import static menion.android.whereyougo.settings.Settings.VALUE_GUIDING_WAYPOINT_SOUND_INCREASE_CLOSER;
import static menion.android.whereyougo.settings.Settings.VALUE_LANGUAGE_AR;
import static menion.android.whereyougo.settings.Settings.VALUE_LANGUAGE_CZ;
import static menion.android.whereyougo.settings.Settings.VALUE_LANGUAGE_DA;
import static menion.android.whereyougo.settings.Settings.VALUE_LANGUAGE_DE;
import static menion.android.whereyougo.settings.Settings.VALUE_LANGUAGE_DEFAULT;
import static menion.android.whereyougo.settings.Settings.VALUE_LANGUAGE_EL;
import static menion.android.whereyougo.settings.Settings.VALUE_LANGUAGE_EN;
import static menion.android.whereyougo.settings.Settings.VALUE_LANGUAGE_ES;
import static menion.android.whereyougo.settings.Settings.VALUE_LANGUAGE_FI;
import static menion.android.whereyougo.settings.Settings.VALUE_LANGUAGE_FR;
import static menion.android.whereyougo.settings.Settings.VALUE_LANGUAGE_HU;
import static menion.android.whereyougo.settings.Settings.VALUE_LANGUAGE_IT;
import static menion.android.whereyougo.settings.Settings.VALUE_LANGUAGE_JA;
import static menion.android.whereyougo.settings.Settings.VALUE_LANGUAGE_KO;
import static menion.android.whereyougo.settings.Settings.VALUE_LANGUAGE_NL;
import static menion.android.whereyougo.settings.Settings.VALUE_LANGUAGE_PL;
import static menion.android.whereyougo.settings.Settings.VALUE_LANGUAGE_PT;
import static menion.android.whereyougo.settings.Settings.VALUE_LANGUAGE_PT_BR;
...
public class SettingItems {
  ...
  public static void addPrefMapProvider(final CustomPreferenceActivity activity,
    ...
    CharSequence[] entries =
        new CharSequence[] {Loc.get(R.string.pref_map_provider_vector),
            Loc.get(R.string.pref_map_provider_locus)};
    CharSequence[] entryValues =
        new CharSequence[] {String.valueOf(Settings.VALUE_MAP_PROVIDER_VECTOR),
            String.valueOf(Settings.VALUE_MAP_PROVIDER_LOCUS)};
    ListPreference pref =
        activity.addListPreference(category, R.string.pref_map_provider,
            R.string.pref_map_provider_desc, Settings.KEY_S_MAP_PROVIDER,
            Settings.DEFAULT_MAP_PROVIDER, entries, entryValues,
  ...
  public static void addPrefStatusbar(CustomPreferenceActivity activity, PreferenceCategory category) {
    activity.addCheckBoxPreference(category, R.string.pref_statusbar, R.string.pref_statusbar_desc,
        Settings.KEY_B_STATUSBAR, Settings.DEFAULT_STATUSBAR,
        new Preference.OnPreferenceChangeListener() {
          @Override
  ...
  public static void addPrefFullscreen(CustomPreferenceActivity activity,
    ...
    activity.addCheckBoxPreference(category, R.string.pref_fullscreen,
        R.string.pref_fullscreen_desc, Settings.KEY_B_FULLSCREEN, Settings.DEFAULT_FULLSCREEN,
        new Preference.OnPreferenceChangeListener() {
          @Override
          public boolean onPreferenceChange(Preference preference, Object newValue) {
  ...
  public static void addPrefConfirmOnExit(CustomPreferenceActivity activity,
    ...
    activity.addCheckBoxPreference(category, R.string.pref_confirm_on_exit,
        R.string.pref_confirm_on_exit_desc, Settings.KEY_B_CONFIRM_ON_EXIT,
  ...
  public static void addPrefHighlight(final CustomPreferenceActivity activity,
      PreferenceCategory category) {
    CharSequence[] entries =
        new CharSequence[] {Loc.get(R.string.pref_highlight_off_text),
            Loc.get(R.string.pref_highlight_only_gps_text),
            Loc.get(R.string.pref_highlight_always_text)};
    CharSequence[] entryValues =
        new CharSequence[] {String.valueOf(Settings.VALUE_HIGHLIGHT_OFF),
    ...
    ListPreference pref =
        activity.addListPreference(category, R.string.pref_highlight, R.string.pref_highlight_desc,
            Settings.KEY_S_HIGHLIGHT, Settings.DEFAULT_HIGHLIGHT, entries, entryValues,
            new Preference.OnPreferenceChangeListener() {
              @Override
              public boolean onPreferenceChange(Preference pref, Object newValue) {
                SettingValues.GLOBAL_HIGHLIGHT = Utils.parseInt(newValue);
                setListPreference(activity, (ListPreference) pref, SettingValues.GLOBAL_HIGHLIGHT,
  ...
  public static void addPrefGpsAltitudeManualCorrection(final CustomPreferenceActivity activity,
    ...
    EditTextPreference pref =
        activity.addEditTextPreference(category, R.string.pref_gps_altitude_manual_correction,
            ...
            Settings.DEFAULT_GPS_ALTITUDE_MANUAL_CORRECTION, InputType.TYPE_CLASS_NUMBER
  ...
  public static void addPrefGpsMinTime(final CustomPreferenceActivity activity,
    ...
    EditTextPreference pref =
        activity.addEditTextPreference(category, R.string.pref_gps_min_time,
            R.string.pref_gps_min_time_desc, Settings.KEY_S_GPS_MIN_TIME_NOTIFICATION,
            Settings.DEFAULT_GPS_MIN_TIME_NOTIFICATION, InputType.TYPE_CLASS_NUMBER,
            new Preference.OnPreferenceChangeListener() {
              @Override
              public boolean onPreferenceChange(Preference pref, Object newValue) {
                ...
                if (value >= 0) {
                  ...
                  setEditTextPreference(activity, (EditTextPreference) pref,
                      SettingValues.GPS_MIN_TIME + "s", R.string.pref_gps_min_time_desc);
                  return true;
                } else {
    ...
    setEditTextPreference(activity, (EditTextPreference) pref, SettingValues.GPS_MIN_TIME + "s",
  ...
  public static void addPrefGpsBeepOnGpsFix(CustomPreferenceActivity activity,
    ...
    activity.addCheckBoxPreference(category, R.string.pref_gps_beep_on_gps_fix,
        R.string.pref_gps_beep_on_gps_fix_desc, Settings.KEY_B_GPS_BEEP_ON_GPS_FIX,
        Settings.DEFAULT_GPS_BEEP_ON_GPS_FIX, new Preference.OnPreferenceChangeListener() {
          @Override
          public boolean onPreferenceChange(Preference preference, Object newValue) {
  ...
  public static void addPrefGpsDisable(CustomPreferenceActivity activity,
    ...
    activity.addCheckBoxPreference(category, R.string.pref_gps_disable,
        R.string.pref_gps_disable_desc, Settings.KEY_B_GPS_DISABLE_WHEN_HIDE,
  ...
  public static void addPrefSensorsCompassHardware(CustomPreferenceActivity activity,
    ...
    activity.addCheckBoxPreference(category, R.string.pref_sensors_compass_hardware,
        R.string.pref_sensors_compass_hardware_desc, Settings.KEY_B_HARDWARE_COMPASS_SENSOR,
        Settings.DEFAULT_HARDWARE_COMPASS_SENSOR, new Preference.OnPreferenceChangeListener() {
          @Override
          public boolean onPreferenceChange(Preference preference, Object newValue) {
  ...
  public static void addPrefSensorsCompassAutoChange(CustomPreferenceActivity activity,
    ...
    activity.addCheckBoxPreference(category, R.string.pref_sensors_compass_auto_change,
        ...
        Settings.KEY_B_HARDWARE_COMPASS_AUTO_CHANGE, Settings.DEFAULT_HARDWARE_COMPASS_AUTO_CHANGE,
        new Preference.OnPreferenceChangeListener() {
          @Override
          public boolean onPreferenceChange(Preference preference, Object newValue) {
  ...
  public static void addPrefSensorsCompassAutoChangeValue(final CustomPreferenceActivity activity,
    ...
    EditTextPreference pref =
        activity.addEditTextPreference(category, R.string.pref_sensors_compass_auto_change_value,
            ...
            Settings.DEFAULT_HARDWARE_COMPASS_AUTO_CHANGE_VALUE, InputType.TYPE_CLASS_NUMBER,
            new Preference.OnPreferenceChangeListener() {
              @Override
              public boolean onPreferenceChange(Preference pref, Object newValue) {
                int value = Utils.parseInt(newValue);
    ...
    setEditTextPreference(activity, pref, SettingValues.SENSOR_HARDWARE_COMPASS_AUTO_CHANGE_VALUE
  ...
  public static void addPrefSensorsBearingTrue(CustomPreferenceActivity activity,
    ...
    activity.addCheckBoxPreference(category, R.string.pref_bearing_true,
        R.string.pref_bearing_true_desc, Settings.KEY_B_SENSORS_BEARING_TRUE,
        Settings.DEFAULT_SENSORS_BEARING_TRUE, new Preference.OnPreferenceChangeListener() {
          @Override
          public boolean onPreferenceChange(Preference preference, Object newValue) {
  ...
  public static void addPrefSensorsOrienFilter(final CustomPreferenceActivity activity,
    ...
    if (!Utils.isAndroid201OrMore())
      return;
    CharSequence[] entries =
        new CharSequence[] {Loc.get(R.string.pref_sensors_orient_filter_no_filter),
    ...
    CharSequence[] entryValues =
        new CharSequence[] {String.valueOf(Settings.VALUE_SENSORS_ORIENT_FILTER_NO),
    ...
    ListPreference pref =
        activity.addListPreference(category, R.string.pref_sensors_orient_filter,
            R.string.pref_sensors_orient_filter_desc, Settings.KEY_S_SENSORS_ORIENT_FILTER,
            Settings.DEFAULT_SENSORS_ORIENT_FILTER, entries, entryValues,
            new Preference.OnPreferenceChangeListener() {
              @Override
              public boolean onPreferenceChange(Preference pref, Object newValue) {
    ...
    setListPreference(activity, (ListPreference) pref, SettingValues.SENSOR_ORIENT_FILTER,
  ...
  public static void addPrefGuidingCompassSounds(CustomPreferenceActivity activity,
    ...
    activity.addCheckBoxPreference(category, R.string.pref_guiding_compass_sounds,
        R.string.pref_guiding_compass_sounds_desc, Settings.KEY_B_GUIDING_COMPASS_SOUNDS,
        Settings.DEFAULT_GUIDING_COMPASS_SOUNDS, new Preference.OnPreferenceChangeListener() {
          @Override
          public boolean onPreferenceChange(Preference preference, Object newValue) {
  ...
  public static void addPrefGuidingGpsRequired(CustomPreferenceActivity activity,
    ...
    activity.addCheckBoxPreference(category, R.string.pref_guiding,
        R.string.pref_guiding_gps_required_desc, Settings.KEY_B_GUIDING_GPS_REQUIRED,
        Settings.DEFAULT_GUIDING_GPS_REQUIRED, new Preference.OnPreferenceChangeListener() {
          @Override
          public boolean onPreferenceChange(Preference preference, Object newValue) {
  ...
  public static void addPrefGuidingWptSound(final CustomPreferenceActivity activity,
    ...
    setPrefGuidingWptSound(activity, pref, SettingValues.GUIDING_WAYPOINT_SOUND);
  }
  ...
  public static void addPrefGuidingWptSoundDistance(final CustomPreferenceActivity activity,
    ...
    EditTextPreference pref =
        activity.addEditTextPreference(category, R.string.pref_guiding_sound_distance,
            ...
            Settings.DEFAULT_GUIDING_WAYPOINT_SOUND_DISTANCE, InputType.TYPE_CLASS_NUMBER,
            new Preference.OnPreferenceChangeListener() {
              @Override
              public boolean onPreferenceChange(Preference pref, Object newValue) {
                int value = Utils.parseInt(newValue);
  ...
  public static void addPrefUnitsAngle(final CustomPreferenceActivity activity,
    ...
    CharSequence[] entryValues =
        new CharSequence[] {String.valueOf(Settings.VALUE_UNITS_ANGLE_DEGREE),
            String.valueOf(Settings.VALUE_UNITS_ANGLE_MIL)};
    ListPreference pref =
        activity.addListPreference(category, R.string.pref_units_angle,
            R.string.pref_units_angle_desc, Settings.KEY_S_UNITS_ANGLE,
            Settings.DEFAULT_UNITS_ANGLE, entries, entryValues,
            new Preference.OnPreferenceChangeListener() {
              @Override
              public boolean onPreferenceChange(Preference pref, Object newValue) {
                SettingValues.FORMAT_ANGLE = Utils.parseInt(newValue);
                setListPreference(activity, (ListPreference) pref, SettingValues.FORMAT_ANGLE,
  ...
  public static void addPrefUnitsCooLatLon(final CustomPreferenceActivity activity,
      PreferenceCategory category) {
    CharSequence[] entries =
        new CharSequence[] {Loc.get(R.string.pref_units_coo_latlon_dec),
            Loc.get(R.string.pref_units_coo_latlon_min),
            Loc.get(R.string.pref_units_coo_latlon_sec)};
    CharSequence[] entryValues =
        new CharSequence[] {String.valueOf(Settings.VALUE_UNITS_COO_LATLON_DEC),
    ...
    ListPreference pref =
        activity.addListPreference(category, R.string.pref_units_coo_latlon,
            R.string.pref_units_coo_latlon_desc, Settings.KEY_S_UNITS_COO_LATLON,
            Settings.DEFAULT_UNITS_COO_LATLON, entries, entryValues,
            new Preference.OnPreferenceChangeListener() {
              @Override
              public boolean onPreferenceChange(Preference pref, Object newValue) {
                SettingValues.FORMAT_COO_LATLON = Utils.parseInt(newValue);
                setListPreference(activity, (ListPreference) pref, SettingValues.FORMAT_COO_LATLON,
  ...
  public static void addPrefUnitsLength(final CustomPreferenceActivity activity,
      PreferenceCategory category) {
    CharSequence[] entries =
        new CharSequence[] {Loc.get(R.string.pref_units_length_me),
            Loc.get(R.string.pref_units_length_im), Loc.get(R.string.pref_units_length_na)};
    CharSequence[] entryValues =
        new CharSequence[] {String.valueOf(Settings.VALUE_UNITS_LENGTH_ME),
    ...
    ListPreference pref =
        activity.addListPreference(category, R.string.pref_units_length,
            R.string.pref_units_length_desc, Settings.KEY_S_UNITS_LENGTH,
            Settings.DEFAULT_UNITS_LENGTH, entries, entryValues,
            new Preference.OnPreferenceChangeListener() {
              @Override
              public boolean onPreferenceChange(Preference pref, Object newValue) {
                SettingValues.FORMAT_LENGTH = Utils.parseInt(newValue);
                setListPreference(activity, (ListPreference) pref, SettingValues.FORMAT_LENGTH,
  ...
  public static void addPrefUnitsAltitude(final CustomPreferenceActivity activity,
      PreferenceCategory category) {
    CharSequence[] entries = new CharSequence[] {Loc.get(R.string.metres), Loc.get(R.string.feet)};
    CharSequence[] entryValues =
        new CharSequence[] {String.valueOf(Settings.VALUE_UNITS_ALTITUDE_METRES),
            String.valueOf(Settings.VALUE_UNITS_ALTITUDE_FEET)};
    ListPreference pref =
        activity.addListPreference(category, R.string.pref_units_altitude,
            R.string.pref_units_altitude_desc, Settings.KEY_S_UNITS_ALTITUDE,
            Settings.DEFAULT_UNITS_ALTITUDE, entries, entryValues,
            new Preference.OnPreferenceChangeListener() {
              @Override
              public boolean onPreferenceChange(Preference pref, Object newValue) {
                SettingValues.FORMAT_ALTITUDE = Utils.parseInt(newValue);
                setListPreference(activity, (ListPreference) pref, SettingValues.FORMAT_ALTITUDE,
  ...
  public static void addPrefUnitsSpeed(final CustomPreferenceActivity activity,
    ...
    CharSequence[] entryValues =
        new CharSequence[] {String.valueOf(Settings.VALUE_UNITS_SPEED_KMH),
    ...
    ListPreference pref =
        activity.addListPreference(category, R.string.pref_units_speed,
            R.string.pref_units_speed_desc, Settings.KEY_S_UNITS_SPEED,
            Settings.DEFAULT_UNITS_SPEED, entries, entryValues,
            new Preference.OnPreferenceChangeListener() {
              @Override
              public boolean onPreferenceChange(Preference pref, Object newValue) {
                SettingValues.FORMAT_SPEED = Utils.parseInt(newValue);
                setListPreference(activity, (ListPreference) pref, SettingValues.FORMAT_SPEED,
      ...
      if (resultCode == Activity.RESULT_OK && data != null) {
        ...
        if (uri != null) {
          ...
          Settings.setPrefString(KEY_S_GUIDING_WAYPOINT_SOUND,
              String.valueOf(VALUE_GUIDING_WAYPOINT_SOUND_CUSTOM_SOUND));
          Settings.setPrefString(VALUE_GUIDING_WAYPOINT_SOUND_CUSTOM_SOUND_URI, uri.toString());

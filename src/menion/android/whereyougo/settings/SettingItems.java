...
public class SettingItems {
	...
	public static void addPrefStatusbar(CustomPreferenceActivity activity,
			PreferenceCategory category) {
		activity.addCheckBoxPreference(category, R.string.pref_statusbar,
				R.string.pref_statusbar_desc, Settings.KEY_B_STATUSBAR,
				Settings.DEFAULT_STATUSBAR,
	...
	public static void addPrefFullscreen(CustomPreferenceActivity activity,
		...
		activity.addCheckBoxPreference(category, R.string.pref_fullscreen,
				R.string.pref_fullscreen_desc, Settings.KEY_B_FULLSCREEN,
	...
	public static void addPrefHighlight(
			final CustomPreferenceActivity activity, PreferenceCategory category) {
		...
		ListPreference pref = activity.addListPreference(category,
				R.string.pref_highlight, R.string.pref_highlight_desc,
				Settings.KEY_S_HIGHLIGHT, Settings.DEFAULT_HIGHLIGHT, entries,
				entryValues, new Preference.OnPreferenceChangeListener() {
					@Override
					public boolean onPreferenceChange(Preference pref,
							Object newValue) {
						SettingValues.GLOBAL_HIGHLIGHT = Utils
								.parseInt(newValue);
						setListPreference(activity, (ListPreference) pref,
								SettingValues.GLOBAL_HIGHLIGHT,
	...
	public static void addPrefGpsAltitudeManualCorrection(
			final CustomPreferenceActivity activity, PreferenceCategory category) {
		EditTextPreference pref = activity.addEditTextPreference(category,
				...
				new Preference.OnPreferenceChangeListener() {
					...
					public boolean onPreferenceChange(Preference pref,
							Object newValue) {
						SettingValues.GPS_ALTITUDE_CORRECTION = Utils
								.parseDouble(newValue);
						setEditTextPreference(
								activity,
								(EditTextPreference) pref,
								UtilsFormat.formatDouble(
										SettingValues.GPS_ALTITUDE_CORRECTION,
										2)
										+ "m",
								R.string.pref_gps_altitude_manual_correction_desc);
						return true;
		...
		setEditTextPreference(
				activity,
				(EditTextPreference) pref,
				UtilsFormat.formatDouble(SettingValues.GPS_ALTITUDE_CORRECTION,
						2) + "m",
				R.string.pref_gps_altitude_manual_correction_desc);
	}

	public static void addPrefGpsMinTime(
			final CustomPreferenceActivity activity, PreferenceCategory category) {
		EditTextPreference pref = activity.addEditTextPreference(category,
				R.string.pref_gps_min_time, R.string.pref_gps_min_time_desc,
				...
				new Preference.OnPreferenceChangeListener() {
					...
					public boolean onPreferenceChange(Preference pref,
						...
						if (value >= 0) {
							...
							setEditTextPreference(activity,
									(EditTextPreference) pref,
							...
							ManagerNotify
									.toastShortMessage(R.string.invalid_value);
							return false;
						}
					}
				});
	...
	public static void addPrefGpsBeepOnGpsFix(
			CustomPreferenceActivity activity, PreferenceCategory category) {
		activity.addCheckBoxPreference(category,
				...
				new Preference.OnPreferenceChangeListener() {
					...
					public boolean onPreferenceChange(Preference preference,
							Object newValue) {
						SettingValues.GPS_BEEP_ON_GPS_FIX = Utils
	...
	public static void addPrefSensorsCompassHardware(
			CustomPreferenceActivity activity, PreferenceCategory category) {
		activity.addCheckBoxPreference(category,
				...
				new Preference.OnPreferenceChangeListener() {
					...
					public boolean onPreferenceChange(Preference preference,
							Object newValue) {
						SettingValues.SENSOR_HARDWARE_COMPASS = Utils
								.parseBoolean(newValue);
	...
	public static void addPrefSensorsCompassAutoChange(
			CustomPreferenceActivity activity, PreferenceCategory category) {
		activity.addCheckBoxPreference(category,
				...
				new Preference.OnPreferenceChangeListener() {
					...
					public boolean onPreferenceChange(Preference preference,
							Object newValue) {
						SettingValues.SENSOR_HARDWARE_COMPASS_AUTO_CHANGE = Utils
								.parseBoolean(newValue);
						A.getRotator().manageSensors();
						return true;
					}
	...
	public static void addPrefSensorsCompassAutoChangeValue(
			final CustomPreferenceActivity activity, PreferenceCategory category) {
		EditTextPreference pref = activity.addEditTextPreference(category,
					...
					public boolean onPreferenceChange(Preference pref,
						...
						if (value > 0) {
							...
							setEditTextPreference(
									activity,
									(EditTextPreference) pref,
									SettingValues.SENSOR_HARDWARE_COMPASS_AUTO_CHANGE_VALUE
											+ "m/s",
									R.string.pref_sensors_compass_auto_change_value_desc);
							return true;
						} else {
	...
	public static void addPrefSensorsBearingTrue(
			CustomPreferenceActivity activity, PreferenceCategory category) {
		activity.addCheckBoxPreference(category, R.string.pref_bearing_true,
				...
				new Preference.OnPreferenceChangeListener() {
					...
					public boolean onPreferenceChange(Preference preference,
							Object newValue) {
						SettingValues.SENSOR_BEARING_TRUE = Utils
								.parseBoolean(newValue);
						return true;
					}
				});
	...
	public static void addPrefSensorsOrienFilter(
			final CustomPreferenceActivity activity, PreferenceCategory category) {
		...
		ListPreference pref = activity.addListPreference(category,
				...
				new Preference.OnPreferenceChangeListener() {
					...
					public boolean onPreferenceChange(Preference pref,
							Object newValue) {
						SettingValues.SENSOR_ORIENT_FILTER = Utils
								.parseInt(newValue);
						setListPreference(activity, (ListPreference) pref,
								SettingValues.SENSOR_ORIENT_FILTER,
								R.string.pref_sensors_orient_filter_desc);
						return true;
					}
				});
	...
	public static void addPrefGuidingCompassSounds(
			CustomPreferenceActivity activity, PreferenceCategory category) {
		activity.addCheckBoxPreference(category,
				...
				new Preference.OnPreferenceChangeListener() {
					...
					public boolean onPreferenceChange(Preference preference,
							Object newValue) {
						setPrefGuidingCompassSounds(false,
								Utils.parseBoolean(newValue));
						return true;
					}
				});
	}

	public static void setPrefGuidingCompassSounds(boolean saveToPref,
			boolean value) {
		if (saveToPref) {
			Settings.setPrefBoolean(Settings.KEY_B_GUIDING_COMPASS_SOUNDS,
					value);
		}
		SettingValues.GUIDING_SOUNDS = value;
	}

	public static void addPrefGuidingGpsRequired(
			CustomPreferenceActivity activity, PreferenceCategory category) {
		activity.addCheckBoxPreference(category, R.string.pref_guiding,
				...
				new Preference.OnPreferenceChangeListener() {
					...
					public boolean onPreferenceChange(Preference preference,
							Object newValue) {
						SettingValues.GUIDING_GPS_REQUIRED = Utils
								.parseBoolean(newValue);
						return true;
					}
				});
	...
	public static void addPrefGuidingWptSound(
			final CustomPreferenceActivity activity, PreferenceCategory category) {
		CharSequence[] entries = new CharSequence[] {
		...
		ListPreference pref = activity.addListPreference(category,
				...
				KEY_S_GUIDING_WAYPOINT_SOUND, DEFAULT_GUIDING_WAYPOINT_SOUND,
				entries, entryValues,
				new Preference.OnPreferenceChangeListener() {
					@Override
					public boolean onPreferenceChange(Preference pref,
						...
						if (result != VALUE_GUIDING_WAYPOINT_SOUND_CUSTOM_SOUND) {
							setPrefGuidingWptSound(activity,
									(ListPreference) pref,
	...
	private static void setPrefGuidingWptSound(
			CustomPreferenceActivity activity, ListPreference pref, int value) {
		SettingValues.GUIDING_WAYPOINT_SOUND = value;
		setListPreference(activity, pref, value,
				R.string.pref_guiding_sound_type_waypoint_desc);
	}

	public static void addPrefGuidingWptSoundDistance(
			final CustomPreferenceActivity activity, PreferenceCategory category) {
		EditTextPreference pref = activity.addEditTextPreference(category,
					...
					public boolean onPreferenceChange(Preference pref,
						...
						if (value > 0) {
							...
							setEditTextPreference(
									activity,
									(EditTextPreference) pref,
									SettingValues.GUIDING_WAYPOINT_SOUND_DISTANCE
											+ "m",
									R.string.pref_guiding_sound_distance_waypoint_desc);
							return true;
						} else {
	...
	public static void addPrefLocal(final CustomPreferenceActivity activity,
		...
		CharSequence[] entryValues = new CharSequence[] {
				VALUE_LANGUAGE_DEFAULT, VALUE_LANGUAGE_AR, VALUE_LANGUAGE_CZ,
				VALUE_LANGUAGE_DA, VALUE_LANGUAGE_DE, VALUE_LANGUAGE_EL,
				VALUE_LANGUAGE_EN, VALUE_LANGUAGE_ES, VALUE_LANGUAGE_FI,
				VALUE_LANGUAGE_FR, VALUE_LANGUAGE_HU, VALUE_LANGUAGE_IT,
				VALUE_LANGUAGE_JA, VALUE_LANGUAGE_KO, VALUE_LANGUAGE_NL,
				VALUE_LANGUAGE_PL, VALUE_LANGUAGE_PT, VALUE_LANGUAGE_PT_BR,
				VALUE_LANGUAGE_RU, VALUE_LANGUAGE_SK };
		ListPreference pref = activity.addListPreference(category,
				R.string.pref_language, R.string.pref_language_desc,
		...
		setPreferenceText(
				activity,
				pref,
				getLanguageText(getPrefString(Settings.KEY_S_LANGUAGE,
	...
	public static void addPrefUnitsAngle(
			final CustomPreferenceActivity activity, PreferenceCategory category) {
		CharSequence[] entries = new CharSequence[] {
		...
		ListPreference pref = activity.addListPreference(category,
				R.string.pref_units_angle, R.string.pref_units_angle_desc,
				Settings.KEY_S_UNITS_ANGLE, Settings.DEFAULT_UNITS_ANGLE,
				entries, entryValues,
				new Preference.OnPreferenceChangeListener() {
					@Override
					public boolean onPreferenceChange(Preference pref,
	...
	public static void addPrefUnitsCooLatLon(
			final CustomPreferenceActivity activity, PreferenceCategory category) {
		CharSequence[] entries = new CharSequence[] {
		...
		ListPreference pref = activity.addListPreference(category,
				...
				new Preference.OnPreferenceChangeListener() {
					...
					public boolean onPreferenceChange(Preference pref,
							Object newValue) {
						SettingValues.FORMAT_COO_LATLON = Utils
								.parseInt(newValue);
						setListPreference(activity, (ListPreference) pref,
								SettingValues.FORMAT_COO_LATLON,
								R.string.pref_units_coo_latlon_desc);
						return true;
					}
				});
	...
	public static void addPrefUnitsLength(
			final CustomPreferenceActivity activity, PreferenceCategory category) {
		CharSequence[] entries = new CharSequence[] {
		...
		ListPreference pref = activity.addListPreference(category,
				R.string.pref_units_length, R.string.pref_units_length_desc,
				Settings.KEY_S_UNITS_LENGTH, Settings.DEFAULT_UNITS_LENGTH,
				entries, entryValues,
				new Preference.OnPreferenceChangeListener() {
					@Override
					public boolean onPreferenceChange(Preference pref,
	...
	public static void addPrefUnitsAltitude(
			final CustomPreferenceActivity activity, PreferenceCategory category) {
		CharSequence[] entries = new CharSequence[] { Loc.get(R.string.metres),
		...
		ListPreference pref = activity.addListPreference(category,
				...
				Settings.KEY_S_UNITS_ALTITUDE, Settings.DEFAULT_UNITS_ALTITUDE,
				entries, entryValues,
				new Preference.OnPreferenceChangeListener() {
					@Override
					public boolean onPreferenceChange(Preference pref,
							Object newValue) {
						SettingValues.FORMAT_ALTITUDE = Utils
								.parseInt(newValue);
						setListPreference(activity, (ListPreference) pref,
								SettingValues.FORMAT_ALTITUDE,
								R.string.pref_units_altitude_desc);
						return true;
					}
				});
	...
	public static void addPrefUnitsSpeed(
			final CustomPreferenceActivity activity, PreferenceCategory category) {
		CharSequence[] entries = new CharSequence[] { "km/h", "miles/h",
				"knots" };
		CharSequence[] entryValues = new CharSequence[] {
		...
		ListPreference pref = activity.addListPreference(category,
				R.string.pref_units_speed, R.string.pref_units_speed_desc,
				Settings.KEY_S_UNITS_SPEED, Settings.DEFAULT_UNITS_SPEED,
				entries, entryValues,
				new Preference.OnPreferenceChangeListener() {
					@Override
					public boolean onPreferenceChange(Preference pref,
	...
	private static void setPreferenceText(Activity activity, Preference pref,
		...
		pref.setSummary(getFormatedText(pref.isEnabled(), value,
				activity.getString(desc)));
	}

	public static void setListPreference(Activity activity,
			ListPreference pref, int index, int desc) {
		setListPreference(activity, pref, index, activity.getString(desc));
	}

	public static void setListPreference(Activity activity,
			ListPreference pref, int index, String desc) {
		pref.setSummary(getFormatedText(pref.isEnabled(),
				pref.getEntries()[index].toString(), desc));
	}

	private static void setEditTextPreference(Activity activity,
			EditTextPreference pref, String value, int desc) {
		pref.setSummary(getFormatedText(pref.isEnabled(), value,
				activity.getString(desc)));
	}

	private static String getFormatedText(boolean enabled, String value,
			String desc) {
		...
		if (requestCode == REQUEST_GUIDING_WPT_SOUND) {
			if (resultCode == Activity.RESULT_OK && data != null) {
				...
				if (uri != null) {
					...
					Settings.setPrefString(KEY_S_GUIDING_WAYPOINT_SOUND, String
							.valueOf(VALUE_GUIDING_WAYPOINT_SOUND_CUSTOM_SOUND));
					Settings.setPrefString(
							VALUE_GUIDING_WAYPOINT_SOUND_CUSTOM_SOUND_URI,
							uri.toString());

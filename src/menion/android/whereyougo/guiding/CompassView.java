...
public class CompassView extends View {
  ...
  private void drawCompassTexts(Canvas c) {
    float space = r1 / 20;
    c.drawText(Loc.get(R.string.distance), cX1, cY1 - paintValueDistance.getTextSize() - space,
        paintValueLabel);
    c.drawText(UtilsFormat.formatDistance(mDistanceToTarget, false), cX1, cY1 - space,
        paintValueDistance);

    c.drawText(Loc.get(R.string.azimuth), cX1, cY1 + paintValueLabel.getTextSize() + space,
        paintValueLabel);

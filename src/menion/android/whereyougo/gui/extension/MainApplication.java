...
public class MainApplication extends Application {
  ...
  public void onCreate() {
    ...
    String lang = settings.getString(Settings.KEY_S_LANGUAGE, Settings.VALUE_LANGUAGE_DEFAULT);
    // Logger.d(TAG, "lang:" + lang + ", system:" + config.locale.getLanguage());
    if (!lang.equals(Settings.VALUE_LANGUAGE_DEFAULT) && !config.locale.getLanguage().equals(lang)) {

...
public abstract class CustomPreferenceActivity extends PreferenceActivity {
  ...
  public EditTextPreference addEditTextPreference(PreferenceCategory category, int name, int desc,
      String key, String def, int inputType, OnPreferenceChangeListener preferenceChangeLis) {
  ...
  public Preference addFilePreference(PreferenceCategory category, int name, int desc, String key,
      String def, final String filter, final int code) {
  ...
  public CheckBoxPreference addCheckBoxPreference(PreferenceCategory category, int name, int desc,
  ...
  public void addCheckBoxPreference(PreferenceCategory category, int name, int desc, String key,
      boolean def, Preference.OnPreferenceChangeListener lis) {
    CheckBoxPreference preference = new CheckBoxPreference(this);
    preference.setTitle(name);
    preference.setSummary(desc);
    preference.setKey(key);
  ...
  public ListPreference addListPreference(PreferenceCategory category, int name, int desc,
      String key, String def, CharSequence[] entries, CharSequence[] entryValues,
  ...
  public void onActivityResult(int requestCode, int resultCode, Intent data) {
    PreferenceItems.handleResponse(this, requestCode, resultCode, data);
  }
  ...
  public void onDestroy() {
    try {
      ...
      if (needRestartFactoryReset) {
        A.getMain().showDialogFinish(CustomMainActivity.FINISH_RESTART_FACTORY_RESET);
      } else if (needRestart) {

...
public class CartridgeDetails extends CustomActivity {
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    buff.append(Loc.get(R.string.distance)).append(": ").append("<b>")
        ...
        .append("</b>").append("<br />").append(Loc.get(R.string.latitude)).append(": ")
        .append(UtilsFormat.formatLatitude(Main.cartridgeFile.latitude)).append("<br />")
    ...
    CustomDialog.setBottom(this, getString(R.string.start), new CustomDialog.OnClickListener() {
      ...
      public boolean onClick(CustomDialog dialog, View v, int btn) {
        ...
        File file =
            new File(Main.selectedFile.substring(0, Main.selectedFile.length() - 3) + "gwl");
